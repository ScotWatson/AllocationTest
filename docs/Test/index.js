...
loadWindow.then(function (evt) {
  ...
  document.body.appendChild(btnAllocateHalfGiB);
  ...
  document.body.appendChild(btnAllocate1GiB);
  ...
  document.body.appendChild(btnAllocate2GiB);
  ...
  document.body.appendChild(btnAllocate4GiB);
  ...
  document.body.appendChild(btnAllocate8GiB);
  ...
  function refresh() {
    ...
    cellBtnHeader.innerHTML = "Remove (" + dataArray.length + ")";
